...
const Auth = () => {
   ...
   // when the form is submitted, dispatch the appropriate action
   ...
   // set the form's state wit the user information
   ...
   //used for styling the left-side image 
   const styles = {
      container: {
         height: '100vh',
         width: '100%',
